                    ...
                    <div class="card card-user">
                        ...
                        <div class="card-body">
                            ...
                            if (Sentinel::check()) {
                                ...
                                if ($user->hasAccess(['action.create'])) { ?>
                                    <div class="py-2">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="text-start" style="width:70%;">Action Name</th>
                                        <th scope="col" class="text-center" style="width:20%;">Options</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    $actions = new Actions();
                                    $actionController = $actions->showActions();
                                    ?>
                                    <?php if (is_array($actionController) && count($actionController) > 0) : ?>
                                        <?php foreach ($actionController as $users) : ?>
                                            <tr>
                                                ...
                                                <td class="text-start" style="width:70%;"><?php echo $users['name'] ?></td>
                                                <td class="text-start" style="width:20%;">
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <?php
                                                        if (Sentinel::check()) {
                                                            $user = Sentinel::getUser();
                                                            if ($user->hasAccess(['action.update'])) { ?>
                                                        ...
                                                        <?php
                                                            ...
                                                            echo "This Role Is Not Available";
                                                        }
                                                        ...
                                                        if (Sentinel::check()) {
                                                            $user = Sentinel::getUser();
                                                            if ($user->hasAccess(['action.delete'])) { ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Add Actions</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="post" action="/tassky/controller/actionController.php">
                        <div class="col-12 px-1 py-2">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Action Name</label>
                                <input type="text" class="form-control mt-2" name="actionName" placeholder="demo Action">
                            </div>
                        </div>
                        <div class="d-flex justify-content-start align-items-center mt-3">
                            <button name="btn_createAction" class="btn btn-outline-primary btn-round mx-2" type="submit">Create</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <form method="post" action="/tassky/controller/actionController.php">
                                <div class="input-block mb-3 d-none">
                                    ...
                                    <input class="form-control" type="text" name="actionId" value="<?php echo $users['id']; ?>">
                                </div>
                                <div class="input-block mb-3">
                                    <label class="col-form-label">Action Name </label>
                                    <input class="form-control" type="text" name="actionName" value="<?php echo $users['name']; ?>">
                                </div>
                                <div class="submit-section">
                                    <button class="btn btn-outline-primary btn-round" name="btn_updateAction" type=" submit">Change</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <form method="post" action="/tassky/controller/actionController.php">
                            <div class="modal-body">
                                ...
                                <div class="d-flex justify-content-end align-items-center mt-3">
                                    ...
                                    <button class="btn btn-outline-danger btn-round" name="btn_removeAction" type=" submit">Yes</button>
                                </div>
                            </div>
                        </form>
